  ...
  return(
    <section className="journal">
      ...
      <ul className="Destination">
        <li className="country-info"><img src={LocationMarker} alt="location-marker" className="location-marker" /><span className="country-name">{props.CountryName}</span> <a href={props.GoogleMaps}className="maps">View on Google Maps</a></li>
